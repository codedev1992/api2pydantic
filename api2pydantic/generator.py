    ...
    def _get_python_type(self, field_name: str, field_schema: Dict) -> str:
        ...
        if len(types) == 1:
            ...
            if type_name == "Dict":
                ...
                nested_model_code = self._generate_model(field_schema, nested_model_name, is_nested=True)
        ...
        union_types = [self._get_python_type(field_name, {"types": [t]}) for t in types if t != "None"]
